if (!window.__dombasedxssfinder_preload && (location.href.startsWith('http://') || location.href.startsWith('https://'))) {
  window.__dombasedxssfinder_preload = true;
  ...
  function __dombasedxssfinder_property_call(object, key, ...arguments) {
    // if (object === null || object === undefined || typeof object[key] !== 'function') {
